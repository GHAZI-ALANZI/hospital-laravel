          ...
          <div class="row">
              ...
              <div class="col-lg-8 col-md-6">
                  <div class="doctor-details mt-4 mt-lg-0">
                      ...
                      <a href="{{ route('appoinment') }}" class="btn btn-main-2 btn-round-full mt-3">Make an Appoinment<i class="icofont-simple-right ml-2  "></i></a>
                  </div>
              </div>
          </div>
      </div>
              ...
              <div class="col-lg-4">
                  <div class="sidebar-widget  gray-bg p-4">
                      ...
                      <div class="sidebar-contatct-info mt-4">
                          ...
                          <h3 class="text-color-2">800-1111-1111</h3>
                      </div>
                  </div>
              </div>
          </div>
