      ...
      <div class="col-lg-12 mb-5">
          <div class="single-blog-item">
              ...
              <div class="blog-item-content mt-5">
                  ...
                  <h2 class="mb-4 text-md"><a href="{{ route('blog-single') }}">Healthy environment to care with modern equipment</a></h2>
          ...
          <div class="comment-area mt-4 mb-5">
              ...
              <ul class="comment-tree list-unstyled">
                  <li class="mb-5">
                      <div class="comment-area-box">
                          <div class="comment-thumb float-left">
                              <img alt="" src="{{ asset('assets/images/blog/testimonial1.jpg') }}" class="img-fluid">
                          </div>
                  ...
                  <li>
                      <div class="comment-area-box">
                          <div class="comment-thumb float-left">
                              <img alt="" src="{{ asset('assets/images/blog/testimonial2.jpg') }}" class="img-fluid">
                          </div>
