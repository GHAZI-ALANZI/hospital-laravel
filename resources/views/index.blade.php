				...
				<div class="feature-block d-lg-flex ">
					<div class="feature-item mb-5 mb-lg-0 ">
						<div class="feature-icon mb-4">
							<i class="icofont-surgeon-alt text-light"></i>
						</div>
						<span>24 Hours Service</span>
						<h4 class="mb-3 text-light">Online Appoinment</h4>
					...
					<div class="feature-item mb-5 mb-lg-0">
						<div class="feature-icon mb-4">
							<i class="icofont-ui-clock text-light"></i>
						</div>
						<span>Timing schedule</span>
						<h4 class="mb-3 text-light">Working Hours</h4>
					...
					<div class="feature-item mb-5 mb-lg-0">
						<div class="feature-icon mb-4">
							<i class="icofont-support text-light"></i>
						</div>
						<span>Emegency Cases</span>
						<h4 class="mb-3 text-light">1-800-700-6200</h4>
		...
		<div class="row align-items-center">
			<div class="col-lg-6 ">
				<div class="appoinment-content">
					<img src="images/about/img-3.jpg" alt="" class="img-fluid">
					<div class="emergency">
						<h2 class="text-lg"><i class="icofont-phone-circle text-lg"></i>800-1111-1111</h2>
					</div>
				</div>
			</div>
