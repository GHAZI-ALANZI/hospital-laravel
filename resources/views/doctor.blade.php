      ...
      <div class="row shuffle-wrapper portfolio-gallery">
                ...
                <div class="position-relative doctor-inner-box">
                  <div class="doctor-profile">
                     <div class="doctor-img">
                             <img src="{{ asset('assets/images/team/1.jpg') }}" alt="doctor-image" class="img-fluid w-100">
                     </div>
                  </div>
                  <div class="content mt-3">
                      <h4 class="mb-0"><a href="{{ route('doctor-single') }}">Thomas Henry</a></h4>
                      <p>Cardiology</p>
                  </div> 
                </div>
            </div>
        ...
        <div class="col-lg-3 col-sm-6 col-md-6 mb-4 shuffle-item" data-groups="[&quot;cat2&quot;]">
              <div class="position-relative doctor-inner-box">
                  <div class="doctor-profile">
                      <div class="doctor-img">
                         <img src="{{ asset('assets/images/team/2.jpg') }}" alt="doctor-image" class="img-fluid w-100">
                      </div>
                  </div>
                  <div class="content mt-3">
        ...
        <div class="col-lg-3 col-sm-6 col-md-6 mb-4 shuffle-item" data-groups="[&quot;cat3&quot;]">
              <div class="position-relative doctor-inner-box">
                  <div class="doctor-profile">
                      <div class="doctor-img">
                         <img src="{{ asset('assets/images/team/3.jpg') }}" alt="doctor-image" class="img-fluid w-100">
                      </div>
                  </div>
                  <div class="content mt-3">
                      <h4 class="mb-0"><a href="{{ route('doctor-single') }}">Alexandar James</a></h4>
                      <p>Dental</p>
                  </div> 
                </div>
        </div>
        ...
        <div class="col-lg-3 col-sm-6 col-md-6 mb-4 shuffle-item" data-groups="[&quot;cat3&quot;,&quot;cat4&quot;]">
              <div class="position-relative doctor-inner-box">
                  <div class="doctor-profile">
                      <div class="doctor-img">
                         <img src="{{ asset('assets/images/team/4.jpg') }}" alt="doctor-image" class="img-fluid w-100">
                      </div>
                  </div>
                  <div class="content mt-3">
                      <h4 class="mb-0"><a href="{{ route('doctor-single') }}">Edward john</a></h4>
                      <p>Pediatry</p>
                  </div> 
                </div>
        </div>
        ...
        <div class="col-lg-3 col-sm-6 col-md-6 mb-4 shuffle-item" data-groups="[&quot;cat6&quot;]">
                  ...
                  <div class="doctor-profile">
                      <div class="doctor-img">
                         <img src="{{ asset('assets/mages/team/3.jpg') }}" alt="doctor-image" class="img-fluid w-100">
                      </div>
                  </div>
                  <div class="content mt-3">
                      <h4 class="mb-0"><a href="{{ route('doctor-single') }}">Henry samuel</a></h4>
                      <p>Palmology</p>
                  </div> 
                </div>
        </div>
        ...
        <div class="col-lg-3 col-sm-6 col-md-6 mb-4 shuffle-item" data-groups="[&quot;cat4&quot;]">
              <div class="position-relative doctor-inner-box">
                  ...
                  <div class="content mt-3">
                      <h4 class="mb-0"><a href="{{ route('doctor-single') }}">Thomas alexandar</a></h4>
                      <p>Cardiology</p>
                  </div> 
              </div>
        </div>
        ...
        <div class="col-lg-3 col-sm-6 col-md-6 mb-4 shuffle-item" data-groups="[&quot;cat5&quot;,&quot;cat6&quot;,&quot;cat1&quot;]">
              <div class="position-relative doctor-inner-box">
                  ...
                  <div class="content mt-3">
                      <h4 class="mb-0"><a href="{{ route('doctor-single') }}">HarissonThomas </a></h4>
                      <p>Traumatology</p>
                  </div> 
                </div>
        </div>
        ...
        <div class="col-lg-3 col-sm-6 col-md-6 mb-4 shuffle-item illustration" data-groups="[&quot;cat2&quot;]">
              <div class="position-relative doctor-inner-box">
                  ...
                  <div class="content mt-3">
                      <h4 class="mb-0"><a href="{{ route('doctor-single') }}">Jonas Thomson</a></h4>
                      <p>Cardiology</p>
                  </div> 
                </div>
          </div>
           ...
           <div class="col-lg-3 col-sm-6 col-md-6 mb-4 shuffle-item" data-groups="[&quot;cat5&quot;,&quot;cat6&quot;,&quot;cat1&quot;]">
              <div class="position-relative doctor-inner-box">
                  ...
                  <div class="content mt-3">
                      <h4 class="mb-0"><a href="{{ route('doctor-single') }}">Henry Forth</a></h4>
                      <p>hematology</p>
                  </div> 
                </div>
        </div>
          ...
          <div class="row">
              <div class="col-lg-7">
                  <div class="cta-content">
                      ...
                      <a href="{{ route('doctor-single') }}" class="btn btn-main-2 btn-round-full">Get appoinment<i class="icofont-simple-right  ml-2"></i></a>
                  </div>
              </div>
          </div>
      </div>
